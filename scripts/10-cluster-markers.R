...
write.csv(cluster_markers,
          file = "results/10-cluster-markers/cluster_markers.csv",
          row.names = F)
...
pdf(file = "results/10-cluster-markers/Heatmap.pdf",
    width = 10,
    height = 12,
    useDingbats = F)
...
write.csv(avg_exp_top_20,
          file = "results/10-cluster-markers/avg_exp_top_20.csv",
          row.names = F)
