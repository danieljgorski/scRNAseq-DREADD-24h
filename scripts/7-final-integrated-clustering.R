...
# Load object
load("results/0-objects/obj_clean.Rdata")
...
save(obj_anchors, file = "results/0-objects/obj_anchors_clean.Rdata")
remove(obj)
remove(obj_list)
...
# Save object
save(obj, file = "results/0-objects/obj_integrated_clean.Rdata")
