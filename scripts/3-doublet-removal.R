...
# Load object
load("results/0-objects/obj_db_classified.Rdata")
...
pdf(file = "results/3-doublet-removal/DimPlot_doublet_classification.pdf",
    useDingbats = F)
print(p)
dev.off()
...
save(obj, file = "results/0-objects/obj_db_removed.Rdata")
